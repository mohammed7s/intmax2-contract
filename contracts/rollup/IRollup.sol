...
interface IRollup {
    ...
    event DepositsProcessed(uint256 indexed lastProcessedDepositId, bytes32 depositTreeRoot);
    ...
    event PubKeysPosted(uint256 indexed blockNumber, uint256[] senderPublicKeys);
     ...
     * @dev Only Liquidity contract can call this function.
     */
    function processDeposits(uint256 lastProcessedDepositId, bytes32[] calldata depositHashes) external;
